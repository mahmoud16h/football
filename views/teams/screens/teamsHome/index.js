import {Text, ScrollView, Button, Image, View, ActivityIndicator} from 'react-native';
...
const TeamsHome = ({ navigation }) => {
  ...
  return (
    <ScrollView contentContainerStyle={{ flex: 1, display: 'flex', justifyContent: 'space-between' }}>
      {hasTeams && <View style={{display: 'flex', flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'center'}}>
        {renderTeams()}
      </View>}
